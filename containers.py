...
class Module(ABC):
    ...
    def register_buffer(self, name, value):
        ...
        if isinstance(value, Parameter):
            raise ValueError(
                "You're trying to register a parameter as a buffer. Perhaps you want to register its contents instead?"
            )
        elif isinstance(value, Module):
            raise ValueError(
                "You're trying to register a module as a buffer. Perhaps you want to register its contents instead?"
            )
